...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(e){if("object"!==(void 0===e?"undefined":r(e)))throw new Error("single-spa-ember requires a configuration object")
var s=t({},n,e)
if(!s.App)throw new Error("single-spa-ember must be passed opts.App")
if(s.createOpts&&"object"!==r(s.createOpts))throw new Error("single-spa-ember: createOpts must be an object to be passed to App.create()")
return{bootstrap:i.bind(null,s),mount:o.bind(null,s),unmount:a.bind(null,s)}},e.loadEmberApp=function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
return new Promise((function(n,i){if("string"==typeof e)if("string"==typeof t)if(r&&"string"!=typeof r)i(new Error("single-spa-ember vendorUrl (the third argument) is optional, but must be a string if present"))
else if(r){var o=document.createElement("script")
o.src=r,o.async=!0,o.onload=a,o.onerror=i,document.head.appendChild(o)}else a()
...
function a(){var r=document.createElement("script")
r.src=t,r.async=!0,r.onload=function(){n(window.require(e+"/app"))},r.onerror=i,document.head.appendChild(r)}}))}
var t=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},n={App:null,createOpts:{}}
...
return e.unshift("single-spa-ember"),define.apply(null,e)}return e.amd=!0,e}()),define("@ember-data/adapter/-private",["exports","require","ember-inflector"],(function(e,t,r){"use strict"
...
"undefined"!=typeof document&&(r.p=(n=document.querySelectorAll("script"))[n.length-1].src.replace(/\/[^/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("single-spa-ember",[],(function(){return r(3)})))},function(e,t,r){"use strict"
...
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},o="function"==typeof Symbol&&"symbol"===n(Symbol.iterator)?function(e){return n(e)}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":n(e)}
...
return{bootstrap:s.bind(null,t),mount:u.bind(null,t),unmount:l.bind(null,t)}},t.loadEmberApp=function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
return new Promise((function(n,i){if("string"==typeof e)if("string"==typeof t)if(r&&"string"!=typeof r)i(new Error("single-spa-ember vendorUrl (the third argument) is optional, but must be a string if present"))
else if(r){var o=document.createElement("script")
o.src=r,o.async=!0,o.onload=a,o.onerror=i,document.head.appendChild(o)}else a()
else i(new Error("single-spa-ember requires an appUrl string as the second argument"))
