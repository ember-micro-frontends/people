...
return Bn({factory:n,internal:!1,type:"component"},t)},e.getComponentManager=function(e){var t=Fn(e)
return t&&!t.internal&&"component"===t.type?t.factory:void 0},e.setModifierManager=function(e,t){return Bn({factory:e,internal:!1,type:"modifier"},t)},e.getModifierManager=Vn,e.modifierCapabilities=function(e,t){void 0===t&&(t={})
...
return n}function Oe(e,t){return e.get(t)}function Ae(e,t){return"attrs"===t[0]&&(t.shift(),1===t.length)?Oe(e,t[0]):Te(e,t)}var Se,Ce,xe=function(e){var t=e.indexOf(":")
if(-1===t)return[e,e,!0]
...
b.EMBER_COMPONENT_IS_VISIBLE&&"style"===s&&void 0!==Se&&(c=new Se(t,c,Oe(t,"isVisible"),o)),r.setAttribute(s,c,!1,null)},ke=ce("display: none;")
...
"function"==typeof u&&u[Ue]?n[a]=u:s[c.UPDATE_REFERENCED_VALUE]&&(n[a]=new qe(s,u)),i[a]=s,r[a]=u}return r.attrs=n,r}var ze=(0,s.symbol)("REF"),qe=function(){function e(e,t){this[u.MUTABLE_CELL]=!0,this[ze]=e,this.value=t}return e.prototype.update=function(e){this[ze][c.UPDATE_REFERENCED_VALUE](e)},e}(),He=function(e,t){var n={}
...
function St(e){return e.capabilities.asyncLifeCycleCallbacks}function Ct(e){return e.capabilities.updateHook}function xt(e){return e.capabilities.destructor}var Pt=new(function(e){function r(){return e.apply(this,arguments)||this}(0,t.inheritsLoose)(r,e)
var o=r.prototype
...
return"function"==typeof r[Ie]?r[Ie].apply(r,i.concat(a)):t.call.apply(t,[Gt].concat(i,a))}}function Wt(e){var t=e.positional,n=t.at(0).value()
...
var un=function(e,t,n,r){this.name=e,this.ModifierClass=t,this.delegate=n,this.state={ModifierClass:t,name:e,delegate:n},this.manager=r?hn:pn},ln=function(){function e(e,t,n,r){this.element=e,this.delegate=t,this.modifier=n,this.args=r,this.tag=(0,h.createUpdatableTag)()}return e.prototype.destroy=function(){var e=this.delegate,t=this.modifier,n=this.args
...
return t.create=function(){return null},t.getTag=function(){return h.CONSTANT_TAG},t.install=function(){},t.update=function(){},t.getDestructor=function(){return null},e}(),hn=new cn,pn=new fn,dn=Ht(),mn=function(){try{var e,t=document.createElement("div"),n=0
...
return t.get=function(e){return new Cn(this,e)},t.value=function(){return this.outletState},t.update=function(e){this.outletState.outlets.main=e,(0,h.dirtyTag)(this.tag)},e}(),Sn=function(){function e(e,t){this.parentStateRef=e,this.outletNameRef=t,this.tag=(0,h.combine)([e.tag,t.tag])}var t=e.prototype
...
function Bn(e,t){return Dn.set(t,e),t}function Fn(e){for(var t=e;null!=t;){var n=Dn.get(t)
if(void 0!==n)return n
t=Un(t)}return null}function Vn(e){var t=Fn(e)
return t&&!t.internal&&"modifier"===t.type?t.factory:void 0}function zn(e){return{object:"component:"+e}}function qn(e,t){return{source:void 0!==e?"template:"+e:void 0,namespace:t}}function Hn(e,t,n){var r=function(e,t,n){var r="component:"+e
...
return function(){return Fe(e,t.value(),n.value(),r,i).apply(void 0,arguments)}}(a.value(),c,s,f,l))[Ue]=!0,new we(n,t.env)},array:function(e){return e.positional.capture()},concat:function(e,t){return new c.HelperRootReference(qt,e.capture(),t.env)},fn:function(e,t){var n=Yt
...
return n=0===e.positional.length?new c.ConstReference("main"):e.positional.at(0),new Pn(new Sn(r.outletState,n),t.env)},"-assert-implicit-component-helper-argument":Ut},Yn=function(){function e(e,t){this.handles=[void 0],this.objToHandle=new WeakMap,this.builtInHelpers=Gn,this.componentDefinitionCache=new Map,this.componentDefinitionCount=0,this.helperDefinitionCount=0,this.isInteractive=t,this.builtInModifiers={action:{manager:new sn,state:null},on:{manager:new En(e,t),state:null}}}var t=e.prototype
...
return te(n)&&t.associateDestroyable({destroy:function(){n.destroy()}}),new Ee(n,e.capture(),t.env)}:null},t._lookupPartial=function(e,t){var n=t.owner,i=jn(e,n)(n)
...
if(null===a.component?g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS&&(l=new Dt(i,n)):(0,T.isTemplateOnlyComponent)(a.component.class)&&(l=new Dt(i,n)),null!==a.component){var c=a.component.class,f=Fn(c)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.computed=Se,e.isComputed=function(e,t){return Boolean(ee(e,t))},e.getCacheFor=v,e.getCachedValueFor=g,e.peekCacheFor=_,e.alias=function(e){return pe(new Pe(e),xe)},e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){we(this,n,e)},get:function(){return _e(this,n)}})},e._getPath=Ee,e.get=_e,e.getWithDefault=function(e,t,n){var r=_e(e,t)
...
S.size>0&&S.delete(e)}(e),(0,a.schedule)("destroy",t,Ue),!0},e.addObserver=C,e.activateObserver=P,e.removeObserver=x,e.flushAsyncObservers=function(e){void 0===e&&(e=!0)
var t=(0,s.valueForTag)(s.CURRENT_TAG)
if(j===t)return
j=t,S.forEach((function(t,r){var i=(0,n.peekMeta)(r)
i&&(i.isSourceDestroying()||i.isMetaDestroyed())?S.delete(r):t.forEach((function(t,n){if(!(0,s.validateTag)(t.tag,t.lastRevision)){var o=function(){try{R(r,n,[r,t.path],void 0,i)}finally{t.tag=(0,s.combine)(ae(r,t.path)),t.lastRevision=(0,s.valueForTag)(t.tag)}}
...
return a?l(n[0],n[1],n[2]):l},e.tagForProperty=B,e.tagForObject=function(e){if((0,r.isObject)(e)){return(0,s.tagFor)(e,U)}return s.CONSTANT_TAG},e.markObjectAsDirty=F,e.tracked=dt,e.addNamespace=function(e){Ve.unprocessedNamespaces=!0,qe.push(e)}
e.classToString=$e,e.findNamespace=function(e){Fe||We()
return He[e]},e.findNamespaces=Ge,e.processNamespace=Ye,e.processAllNamespaces=We,e.removeNamespace=function(e){var t=(0,r.getName)(e)
...
var k=!1,N=[]
function M(e,t,n){if(void 0===n&&(n=!1),!0!==k){var r=!0===n?A:S,i=r.get(e)
...
null!==o&&(o.isInitializing()||o.isPrototypeMeta(e))||(F(e,t),z<=0&&I(),V in e&&(4===arguments.length?e[V](t,i):e[V](t)))}function H(){z++,k=!0}function G(){--z<=0&&(I(),function(){k=!1
for(var e,n=(0,t.createForOfIteratorHelperLoose)(N);!(e=n()).done;){var r=e.value
M(r[0],r[1],r[2])}N=[]}())}function Y(e){H()
...
o&&((i<0||r<0||i-r!=0)&&q(e,"length",a),q(e,"[]",a)),R(e,"@array:change",[e,t,r,i])
var s=_(e)
...
return r(e,"@array:before",t,o),r(e,"@array:change",t,a),s===i&&q(e,"hasArrayObservers"),e}var Z=new WeakMap
...
return void 0!==s&&he.has(s)?(e[t]=n,n):(void 0!==(o=e[t])||"object"!=typeof e||t in e||"function"!=typeof e.setUnknownProperty?(e[t]=n,o!==n&&q(e,t)):e.setUnknownProperty(t,n),n)}}function Re(e,t,n,r){var i=t.split("."),o=i.pop(),a=Ee(e,i)
...
var r
try{H(),ie(e,t,r=this._set(e,t,n))
var i=B(e,t)
...
return r(t[0],t[1],t[2])}return pe(new Oe(t),Ae)}var Ce=Se.bind(null)
...
var Be=Object.prototype.hasOwnProperty,Fe=!1,Ve={_set:0,_unprocessedNamespaces:!1,get unprocessedNamespaces(){return this._unprocessedNamespaces},set unprocessedNamespaces(e){this._set++,this._unprocessedNamespaces=e}},ze=!1,qe=[]
e.NAMESPACES=qe
...
for(var s in He[a]=n,(0,r.setName)(n,a),n)if(Be.call(n,s)){var u=n[s]
...
if(e&&(Ge(),Ve.unprocessedNamespaces=!1),e||ze){for(var t=qe,n=0;n<t.length;n++)Ye(t[n])
...
R=E(R)
var T=y.type||(0,o.typeOf)(R),O=this.serializeQueryParam(R,w,T),A=a+":"+g,S={undecoratedDefaultValue:(0,r.get)(u,g),defaultValue:R,serializedDefaultValue:O,serializedValue:O,type:T,urlKey:w,prop:g,scopedPropertyName:A,controllerName:a,route:this,parts:_,values:null,scope:b}
...
e.NativeArray=C
var x,P=["length"]
C.keys().forEach((function(e){Array.prototype[e]&&P.push(e)})),e.NativeArray=C=(f=C).without.apply(f,P),e.A=x,a.ENV.EXTEND_PROTOTYPES.Array?(C.apply(Array.prototype),e.A=x=function(e){return e||[]}):e.A=x=function(e){return e||(e=[]),A.detect(e)?e:C.apply(e)}
var k=A
...
return C(e,t)},e.getObservers=R,e.getListeners=A,e.setObservers=w,e.setListeners=O,e.inspect=function(e){if("number"==typeof e&&2===arguments.length)return this
...
function O(e,t){t&&T.set(e,t)}function A(e){return T.get(e)}var S=new t._WeakSet
function C(e,t){function n(){var n=this._super
this._super=t
var r=e.apply(this,arguments)
return this._super=n,r}return S.add(n),w(n,R(e)),O(n,A(e)),n}var x=Object.prototype.toString,P=Function.prototype.toString,k=Array.isArray,N=Object.keys,M=JSON.stringify,j=/^[\w$]+$/
...
function z(e){return null==e}var q="function"==typeof Symbol&&"symbol"==typeof Symbol()
...
return E(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return O(this)}},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return R(this)}},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return T(this)}},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return S(this)}},classify:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return A(this)}},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return C(this)}}})}))
...
e.NONE=j
var I={"not-handled":!0}
function L(e){return e&&!!e["no-action"]}function D(e){return!e||!e["not-handled"]}function U(e,n){if(!L(n))if(Array.isArray(n))for(var r,i=(0,t.createForOfIteratorHelperLoose)(n);!(r=i()).done;){U(e,r.value)}else"Simple"===n.type?S(e,n):x(e.encoder,e.syntax.program.constants,n)}function B(e,n,i,o){if(!L(i))if(Array.isArray(i))for(var a,s=(0,t.createForOfIteratorHelperLoose)(i);!(a=s()).done;){B(e,n,a.value,o)}else if("Number"===i.type)x(e,o,i)
...
return ve(r.meta,{definition:a,attrs:null,params:s,hash:n,atNames:!1,blocks:ne})})),{blocks:e,inlines:t}}(new z,new q),t=e.blocks,r=e.inlines
...
function H(e,t){return{syntax:e,encoder:new ce,meta:t}}var G=new P,Y=["class","id","value","name","type","style","href"],W=["div","span","p","a"]
...
return new J(t.statements,he(e),{symbols:t.symbols,hasEval:t.hasEval})}function Z(e,t,n){for(var r=G,i=H(n,t),o=0;o<e.length;o++)F(i,r.compile(e[o],i.meta))
...
var t,o,a,s,u=he(this.layout),l=H(e,u)
...
function O(e,t){switch(e){case"@key":return C(w)
...
null!==r&&t.didDestroy((0,n.snapshot)(r))}function R(e,t){t.willDestroy((0,n.destructor)(e))}function T(e,t){t.didDestroy((0,n.destructor)(e))}var O=function(){function e(e){this.node=e}return e.prototype.firstNode=function(){return this.node},e}(),A=function(){function e(e){this.node=e}return e.prototype.lastNode=function(){return this.node},e}(),S=(0,n.symbol)("CURSOR_STACK"),C=function(){function e(e,t,r){this.constructing=null,this.operations=null,this[g]=new n.Stack,this.modifierStack=new n.Stack,this.blockStack=new n.Stack,this.pushElement(t,r),this.env=e,this.dom=e.getAppendOperations(),this.updateOperations=e.getDOM()}e.forInitialRender=function(e,t){return new this(e,t.element,t.nextSibling).initialize()},e.resume=function(e,t){var n=new this(e,t.parentElement(),t.reset(e)).initialize()
return n.pushLiveBlock(t),n}
var r=e.prototype
return r.initialize=function(){return this.pushSimpleBlock(),this},r.debugBlocks=function(){return this.blockStack.toArray()},r.block=function(){return this.blockStack.current},r.popElement=function(){this[S].pop(),this[S].current},r.pushSimpleBlock=function(){return this.pushLiveBlock(new x(this.element))},r.pushUpdatableBlock=function(){return this.pushLiveBlock(new k(this.element))},r.pushBlockList=function(e){return this.pushLiveBlock(new N(this.element,e))},r.pushLiveBlock=function(e,t){void 0===t&&(t=!1)
...
var z=V
z=D(F,z)
var q=z=L(F,z,"http://www.w3.org/2000/svg")
e.DOMChanges=q
...
i!==a.CONSTANT_TAG&&t.push(i)}return(0,a.createCombinatorTag)(t)}function He(e){for(var t=[],n=e.head();null!==n;){var r=n.tag
...
var nt=function(){function e(e){this.list=e,this.tag=qe(e),this.list=e}return e.prototype.value=function(){for(var e=[],t=this.list,n=0;n<t.length;n++){var r=ee(t[n].value())
...
e.elements().appendDynamicHTML(n)})),Ve.add(47,(function(e){var t=e.stack.pop(),n=t.value(),r=te(n)?"":String(n),i=e.elements().appendDynamicText(r);(0,a.isConstTagged)(t)||e.updateWith(new it(i,t,r))})),Ve.add(45,(function(e){var t=e.stack.pop().value()
...
e.stack.peek()===r&&e.goto(n)})),Ve.add(68,(function(e){var t=e.stack.peek();(0,a.isConstTagged)(t)||e.updateWith(at.initialize(new r.ReferenceCache(t)))})),Ve.add(71,(function(e){var t=e.env,n=e.stack
...
e.elements().setStaticAttribute(o,a,s)})),Ve.add(52,(function(e,t){var n=t.op1,r=t.op2,i=t.op3,o=e[p].getString(n),s=e.stack.pop(),u=s.value(),l=i?e[p].getString(i):null,c=e.elements().setDynamicAttribute(o,u,!!r,l);(0,a.isConstTagged)(s)||e.updateWith(new ft(s,c))}))
...
_[R]=T}if(b)for(var O=0;O<v.length;O++){var A=O+1,S=b[v[O]]
...
t>0&&null!==e&&e.pop(t)},(0,t.createClass)(e,[{key:"tag",get:function(){return qe([this.positional,this.named])}},{key:"base",get:function(){return this.blocks.base}},{key:"length",get:function(){return this.positional.length+this.named.length+3*this.blocks.length}}]),e}(),kt=function(){function e(){this.base=0,this.length=0,this.stack=null,this._tag=null,this._references=null}var r=e.prototype
...
case 6:return this.returnTo(e.op1)}},t.evaluateSyscall=function(e,t){Ve.evaluate(t,e,e.type)},e}(),qt=function(){function e(e,t){var r=t.alwaysRevalidate,i=void 0!==r&&r
...
e.UpdatingVM=qt
var Ht,Gt,Yt=function(){function e(e,t){this.state=e,this.resumeCallback=t}return e.prototype.resume=function(e,t){return this.resumeCallback(e,this.state,t)},e}(),Wt=function(e){function n(t,n,r,i){var o
...
var i=r.prototype
return i.didInitializeChildren=function(){(0,a.updateTag)(this._tag,He(this.children))},i.evaluate=function(e){e.try(this.children,this)},i.handleException=function(){var e=this,t=this.state,r=this.bounds,i=this.children,o=this.prev,a=this.next,s=this.runtime
E(this,s.env),i.clear(),w(this,s.env)
var u=C.resume(s.env,r),l=t.resume(s,u),c=new n.LinkedList,f=l.execute((function(t){t.pushUpdating(c),t.updateWith(e),t.pushUpdating(i)}));(0,n.associate)(this,f.drop),this.prev=o,this.next=a},r}(Wt),Qt=function(){function e(e,t){this.opcode=e,this.marker=t,this.didInsert=!1,this.didDelete=!1,this.map=e.map,this.updating=e.children}var t=e.prototype
...
var i=n.prototype
return i.didInitializeChildren=function(e){void 0===e&&(e=!0),this.lastIterated=(0,a.valueForTag)(this.artifacts.tag),e&&(0,a.updateTag)(this._tag,He(this.children))},i.evaluate=function(t){var n=this.artifacts,i=this.lastIterated
...
this.runtime=e,this.elementStack=r,this[Ht]=new tn,this[Gt]=new n.Stack,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null
var g=en.restore(v)
...
function rn(e,t,n){return void 0===t&&(t=Ce.root($,0)),{pc:e,scope:t,dynamicScope:n,stack:[]}}e.LowLevelVM=nn,Ht=c,Gt=l
var on=function(e){function n(){return e.apply(this,arguments)||this}return(0,t.inheritsLoose)(n,e),n.empty=function(e,t){var n=t.handle,r=t.treeBuilder,i=t.dynamicScope,o=an(e,rn(e.program.heap.getaddr(n),Ce.root($,0),i),r)
...
return c.pushUpdating(),c},r.empty=function(e,t,n){var r=t.handle,i=t.treeBuilder,o=t.dynamicScope,a=sn(n)(e,rn(e.program.heap.getaddr(r),Ce.root($,0),o),i)
...
return t||(t=h(e)?new O(e):p(e)?new A(e):new S(e),y.set(e,t)),t}e.DESTRUCTORS=y
...
r===v?n.subtag=null:(n.subtagBufferCache=r[s](),n.subtag=r)},e.dirtyTag=function(e){e.revision=++a},e}(),p=h.dirtyTag
e.dirtyTag=p
var d=h.updateTag
function m(){return new h(1)}e.updateTag=d
var v=new h(3)
...
function S(e,t){if(!O(e))throw new Error("BUG: Can't update a tag for a primitive")
var n=A.get(e)
if(void 0!==n){var r=n.get(t)
void 0!==r&&(p(r),T())}}function C(e,t){if(O(e)){var n=A.get(e)
if(void 0===n)n=new Map,A.set(e,n)
else if(n.has(t))return n.get(t)
var r=m()
return n.set(t,r),r}return v}var x=function(){function e(){this.tags=new Set,this.last=null}var t=e.prototype
...
var L=o("FN"),D=o("LAST_VALUE"),U=o("TAG"),B=o("SNAPSHOT")
o("DEBUG_LABEL")
function F(e,t){var n
var r=((n={})[L]=e,n[D]=void 0,n[U]=void 0,n[B]=-1,n)
return r}function V(e){q(e,"getValue")
var t=e[L],n=e[U],r=e[B]
if(void 0!==n&&l(n,r))j(n)
else{N()
try{e[D]=t()}finally{n=M(),e[U]=n,e[B]=u(),j(n)}}return e[D]}function z(e){q(e,"isConst")
var t=e[U]
...
e=o[0],t=o[1],void 0===(r=o[2])?i=0:s(i=r.pop())||(n=!0===i,i=r.pop())}return[e,t,r,i=parseInt(i,10),n]}var E=0,w=0,R=0,T=0,O=0,A=0,S=0,C=0,x=0,P=0,k=0,N=0,M=0,j=0,I=0,L=0,D=0,U=0,B=0,F=0,V=0,z=function(){function e(e,t){var n=this
...
return new V(T,e,t,n).promise}))}function q(e,t){return T.resolve(e,t)}function H(e,t){return T.reject(e,t)}var G={},Y=function(e){function t(){return e.apply(this,arguments)||this}(0,n.inheritsLoose)(t,e)
var r=t.prototype
...
for(var ge in a("instrument",!0),ve)ve.hasOwnProperty(ge)&&de(ge,ve[ge])}var ye={asap:K,cast:he,Promise:T,EventTarget:i,all:k,allSettled:M,race:j,hash:L,hashSettled:U,rethrow:B,defer:F,denodeify:C,configure:a,on:de,off:me,resolve:q,reject:H,map:z,async:pe,filter:W}
...
var c=0
function f(e){return c--,e}e.Ember.Test?(e.Ember.Test.registerWaiter((function(){return 0===c})),t.default=function(){return c++,t.fetch.apply(e,arguments).then((function(e){return e.clone().blob().then(f,f),e}),(function(e){throw f(e),e}))}):t.default=t.fetch,r.forEach((function(e){delete t[e]}))}))})("undefined"!=typeof window&&window||"undefined"!=typeof globalThis&&globalThis||"undefined"!=typeof self&&self||"undefined"!=typeof global&&global)}(function(e){e("single-spa-ember/src/single-spa-ember",["exports"],(function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=function(e){if("object"!==(void 0===e?"undefined":n(e)))throw new Error("single-spa-ember requires a configuration object")
var s=t({},r,e)
if(!s.App)throw new Error("single-spa-ember must be passed opts.App")
if(s.createOpts&&"object"!==n(s.createOpts))throw new Error("single-spa-ember: createOpts must be an object to be passed to App.create()")
return{bootstrap:i.bind(null,s),mount:o.bind(null,s),unmount:a.bind(null,s)}},e.loadEmberApp=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
return new Promise((function(r,i){if("string"==typeof e)if("string"==typeof t)if(n&&"string"!=typeof n)i(new Error("single-spa-ember vendorUrl (the third argument) is optional, but must be a string if present"))
else if(n){var o=document.createElement("script")
o.src=n,o.async=!0,o.onload=a,o.onerror=i,document.head.appendChild(o)}else a()
else i(new Error("single-spa-ember requires an appUrl string as the second argument"))
else i(new Error("single-spa-ember requires an appName string as the first argument"))
function a(){var n=document.createElement("script")
n.src=t,n.async=!0,n.onload=function(){r(window.require(e+"/app"))},n.onerror=i,document.head.appendChild(n)}}))}
var t=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},r={App:null,createOpts:{}}
function i(e){return Promise.resolve()}function o(e){return Promise.resolve().then((function(){e.applicationInstance=e.App.create(e.createOpts)}))}function a(e){return Promise.resolve().then((function(){e.applicationInstance.destroy(),e.applicationInstance=null}))}}))})(function(){function e(){var e=Array.prototype.slice.call(arguments)
return e.unshift("single-spa-ember"),define.apply(null,e)}return e.amd=!0,e}()),define("@glimmer/component/-private/base-component-manager",["exports","@glimmer/component/-private/component"],(function(e,t){"use strict"
...
"undefined"!=typeof document&&(n.p=(r=document.querySelectorAll("script"))[r.length-1].src.replace(/\/[^/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("single-spa-ember",[],(function(){return n(3)})))},function(e,t,n){"use strict"
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},o="function"==typeof Symbol&&"symbol"===r(Symbol.iterator)?function(e){return r(e)}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":r(e)}
t.default=function(e){if("object"!==(void 0===e?"undefined":o(e)))throw new Error("single-spa-ember requires a configuration object")
var t=i({},a,e)
...
return{bootstrap:s.bind(null,t),mount:u.bind(null,t),unmount:l.bind(null,t)}},t.loadEmberApp=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
return new Promise((function(r,i){if("string"==typeof e)if("string"==typeof t)if(n&&"string"!=typeof n)i(new Error("single-spa-ember vendorUrl (the third argument) is optional, but must be a string if present"))
else if(n){var o=document.createElement("script")
o.src=n,o.async=!0,o.onload=a,o.onerror=i,document.head.appendChild(o)}else a()
else i(new Error("single-spa-ember requires an appUrl string as the second argument"))
...
function a(){var n=document.createElement("script")
n.src=t,n.async=!0,n.onload=function(){r(window.require(e+"/app"))},n.onerror=i,document.head.appendChild(n)}}))}
var a={App:null,createOpts:{}}
function s(e){return Promise.resolve()}function u(e){return Promise.resolve().then((function(){e.applicationInstance=e.App.create(e.createOpts)}))}function l(e){return Promise.resolve().then((function(){e.applicationInstance.destroy(),e.applicationInstance=null}))}}])
